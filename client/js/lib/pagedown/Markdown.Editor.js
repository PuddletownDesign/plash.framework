...
(function () {
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            buttons.hr = makeButton("wmd-hr-button", "Horizontal Rule <hr> Ctrl+e", "-180px", bindCommand("doHorizontalRule"));
            makeSpacer(3);
    ...
    commandProto.doHeading = function (chunk, postProcessing) {
        ...
        var headerLevel = 5;     // The existing header level of the selected text.
