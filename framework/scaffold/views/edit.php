...
<head>
	...
	<title>Edit Entry #<?=$post['id'];?></title>
	<style type="text/css">
...
<body>
	<div id="wrapper">
		<h1>Scaffolding &laquo; Edit <span class="table"><?=$this->table;?></span> entry #<?=$post['id'];?></h1>
...
if ($meta): ?>
	...
	<?php endfor;?>
			<div class="submit-button">
				...
				<input type="submit" id="submit" value="Edit This Entry">
			</div>
		</form>
